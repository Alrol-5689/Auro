...
public class GpConductores {
	...
	public Conductor validarLoginConductor(String nik, String pin, Utilities u, Validador v) 
			throws NikNoEncontradoException, PinInvalidoException, PinIncorrectoException {
